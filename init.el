...
(custom-set-variables
 ...
 '(package-selected-packages
   '(ox-hugo mentor grayscale-theme copilot gptel solarized-theme nofrils-acme-theme acme-theme plan9-theme desktop-environment exwm yasnippet yaml-mode which-key web-mode vue-mode vertico typescript-mode sudo-edit sly rust-mode rainbow-delimiters php-mode openwith nvm multi-vterm move-text magit lua-mode lsp-mode json-mode helm gruvbox-theme go-mode geiser-guile flycheck evil-mc emms editorconfig eat doom-modeline diff-hl counsel corfu consult catppuccin-theme all-the-icons)))
(custom-set-faces
