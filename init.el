...
(custom-set-variables
 ...
 '(package-selected-packages
   '(counsel swiper exwm yasnippet yaml-mode which-key web-mode vue-mode vertico typescript-mode sudo-edit solarized-theme sly rust-mode php-mode nvm nerd-icons multi-vterm move-text magit lua-mode lsp-mode lemon json-mode ivy gruvbox-theme go-mode flycheck evil-mc emms editorconfig eat diff-hl corfu consult catppuccin-theme all-the-icons)))
(custom-set-faces
